...
<?php
add_stylesheet('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_JS_URL.'/font-awesome/css/font-awesome.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Lobster&family=Merienda:wght@400;700&family=Roboto:wght@400;700&display=swap">', 0);
add_stylesheet('<link rel="stylesheet" type="text/css" href="https://cdn.rawgit.com/openhiun/hangul/14c0f6faa2941116bb53001d6a7dcd5e82300c3f/nanumbarungothic.css">', 0);
add_javascript('<script src="'.G5_JS_URL.'/jquery-1.12.4.min.js"></script>', 0);
add_javascript('<script src="'.G5_JS_URL.'/jquery-ui-1.12.1.min.js"></script>', 0);
...
/* 사용자 js , css 파일 링크 add_javascript(), add_stylesheet() 함수사용 - 끝에 숫자는 출력순서 ( 작을수록먼저출력 ) */
...
if(G5_IS_MOBILE) {
  ...
  add_javascript('<script src="/mobile/js/common.js"></script>', 1);
    /* 사용자 모바일 전용 js, css 파일 링크 add_javascript(), add_stylesheet() 함수사용 - 끝에 숫자는 출력순서 ( 작을수록먼저출력 ) */
