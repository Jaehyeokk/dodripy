...
<section id="bo_w">
    ...
    <table class="w_tables" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input w_inputs required" size="50" maxlength="255" placeholder="제목">
            </td>
        </tr>
        <tr>
