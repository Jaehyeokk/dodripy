    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
                ...
                <strong><?php echo $view['ca_name']; // 분류 출력 끝 ?></strong>
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
				<li class="pc_view"><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fa fa-bars" aria-hidden="true"></i><span class="sound_only">목록</span></a></li>
	            <?php if ($reply_href) { ?><li class="pc_view"><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="sound_only">답변</span></a></li><?php } ?>
	            <?php if ($write_href) { ?><li class="pc_view"><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="작성"><i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">작성</span></a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_share">
            ...
            <div class="btn_bo_user_btm_v">
                ...
                <li class="btn_v_01">
                    ...
                    <?php if ($write_href) { ?>
                    <a href="<?php echo $write_href ?>" class="btn_b01 btn" title="작성하기">
        ...
        <?/* if ($is_signature) { ?><p><?php echo $signature ?></p><?php } */?>
