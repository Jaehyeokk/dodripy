...
<div class="viewskin">
	<div class="khwrap">
		...
		<div class="standard">
			...
			<div class="imgthb">
				...
				for ($i=0; $i<=count($view['file']); $i++) {
					...
					if ($view['file'][0]['file']) {
						...
						if (preg_match("/\.(gif|jpg|png)$/i", $image) && file_exists(G5_PATH.'/data/file/'.$bo_table.'/'.$image)) {
							echo '<li><a class="inner"><i class="xi-expand-square"></i>';
			...
			<div class="inq">
				<a href="/content/request"><i class="xi-mail-o"></i> <span><?php echo _("온라인 문의") ?></span></a>
			</div>
		</div>
		<?php if($view['file']): ?>
	...
	<div class="button">
		<div class="khwrap">
			<i class="xi-caret-up-square-o"></i> <a><?php echo _("상세내역") ?></a>
		</div>
	</div>
	<div class="detail">
		<div class="khwrap">
